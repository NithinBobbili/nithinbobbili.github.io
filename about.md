...
I am passionate about solving complex data problems, enabling real-time insights, and collaborating with cross-functional teams to deliver business-driven analytics solutions. I am seeking full-time opportunities where I can continue to innovate as a data engineer and contribute to impactful, cloud-native data initiatives.</p>

<h2>Skills</h2>

<ul class="skill-list">
	<li>Programming Languages & Big Data: Python, Scala, Java, SQL, Apache Spark, PySpark, Hadoop, Hive, Pig, Sqoop, IBM DataStage, Spark SQL, Apache Kafka, Apache Flink, Airflow, Oozi</li>
<li>Databases & Warehousing: Azure Synapse, Snowflake, Redshift, MySQL, PostgreSQL, SQL Server, Azure SQL DB, DynamoDB, MongoDB, HBase, Teradata </li>
<li>Cloud Platforms & Services: Azure (ADF, Databricks, Function, Logic Apps), AWS (EMR, Glue, Lambda, EC2, S3, RDS, Redshift, Kinesis, IAM, Elastic search,
 CloudWatch) </li>
...
<li>Cloud: Salesforce Commerce Cloud (SFCC), AWS (EC2, Sagemaker, S3).Core Competencies & Methodologies: Custom Data Quality Frameworks, RCA, Governance Policies, Agile/Scrum, Kanban, SDLC. </li>
